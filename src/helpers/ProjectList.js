...
export const ProjectList = [
...

  {
    ...
    image: IconicThreads,
    description:
      "Developed a feature-rich e-commerce platform with Spring Boot, providing a seamless experience for managing customers, products, orders, and reviews. The platform supports essential e-commerce functionalities and incorporates a robust search feature for efficient product discovery.",
    keyfeatures: [
...

  {
    ...
    image: Portfolio,
    description:
      "Developed a personal portfolio website showcasing my skills in front-end and back-end development, as well as cloud engineering.",
    keyfeatures: [
      "The site features an overview of my professional journey, a detailed project gallery with descriptions and key features, and integrated links to my GitHub and LinkedIn profiles.",
